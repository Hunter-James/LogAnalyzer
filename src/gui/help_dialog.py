...
<ul>
  ...
  <li><b>Печать кодов</b>: запросы на печать, отправлено в принтер, через SATO.</li>
  <li><b>Агрегация</b>: попыток, завершено, ответов на завершение, очищено групп.</li>
  <li><b>Сканирование и верификация</b>: HIKROBOT-сканы, обработанные изображения, ошибки «не найден в базе».</li>
  <li><b>Обмен с Л2 / Сериализация / HTTP</b>: синхронизации, подтверждения печати, кол-во HTTP-запросов.</li>
  <li><b>Ритм работы</b>: среднее Δt между сканированиями, длинные паузы &gt; 5 минут (возможные простои оператора).</li>
  <li><b>Самые активные минуты</b> — топ-5 минут с пиковой активностью (с визуальной шкалой).</li>
  <li><b>Самые активные компоненты</b> — топ-5 логгеров.</li>
  <li><b>Топ ошибок</b> — самые частые ERROR с количеством.</li>
</ul>
