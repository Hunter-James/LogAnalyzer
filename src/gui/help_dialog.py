...
<ul>
  <li>Кнопка <b>Партии</b> делит лог на сегменты по запросам:
    <ul>
  ...
  <li>В меню каждый пункт — одна партия, с указанием числа строк и временного диапазона в tooltip. Несколько сегментов с одним <code>batchId</code> (партию открывали-закрывали несколько раз) объединяются в один пункт.</li>
